...
if ( -d /usr/lib@LIBDIRSUFFIX@/libexec/kf5 ) then
    setenv PATH ${PATH}:/usr/lib@LIBDIRSUFFIX@/libexec/kf5
endif
if ( -d /usr/lib@LIBDIRSUFFIX@/kde4/libexec ) then
    setenv PATH ${PATH}:/usr/lib@LIBDIRSUFFIX@/kde4/libexec
endif
